...
const Family = ({weekday, month}) => {
    ...
    useEffect( () => {
        function getData() {
            dataBase.collection("Family").orderBy('timestamp', 'desc').onSnapshot(item => 
    ...
    const NewNote = (e) => {
        ...
        dataBase.collection("Family").doc(`${Math.random() * 526}`).set({
            id: newNote.id,
                        ...
                        <div className="notes" key={id}>
                                    ...
                                    control={<Checkbox 
                                        ...
                                        onChange={() =>                                             
                                            function(){
                                                ...
                                                dataBase.collection("Family").doc(id).set({
                                                    id: data.id,
                                                    solved: noteSolved,
                                                    note: data.note,
                            ...
                            <div className={`prompt-user ${noteId === data.id && deleteNote ? "show-prompt" : ""}`}>
                                ...
                                <span 
                                    ...
                                    dataBase.collection("Family").doc(id).delete();
                                    setDeleteNote(false);
                                        }()} 
                                >Yes
                                </span>
