...
const Groceries = ({weekday, month}) => {
    ...
    useEffect( () => {
        function getData() {
            dataBase.collection("Groceries").orderBy('timestamp', 'desc').onSnapshot(item => 
    ...
    const NewNote = (e) => {
        ...
        dataBase.collection("Groceries").doc(`${Math.random() * 526}`).set({
            id: newNote.id,
    ...
    return (
        <div className="groceries">
            ...
            <div style={{height: '.2rem', width: '100%', background: 'white'}}>
            </div>
                        ...
                        <div className="notes" key={id}>
                                    ...
                                    control={<Checkbox 
                                        ...
                                        onChange={() =>                                             
                                            function(){
                                                ...
                                                dataBase.collection("Groceries").doc(id).set({
                                                    id: data.id,
                                                    solved: noteSolved,
                                                    note: data.note,
                            ...
                            <div className={`prompt-user ${noteId === data.id && deleteNote ? "show-prompt" : ""}`}>
                                ...
                                <span 
                                    ...
                                    dataBase.collection("Groceries").doc(id).delete();
                                    setDeleteNote(false);
                                        }()} 
                                >Yes
                                </span>
